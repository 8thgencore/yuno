...
class ChangePasswordEvent with _$ChangePasswordEvent {
  ...
  const factory ChangePasswordEvent.currentPasswordChanged(String text) =
      _CurrentPasswordChangedEvent;

  const factory ChangePasswordEvent.newPasswordChanged(String text) = _NewPasswordChangedEvent;

  const factory ChangePasswordEvent.confirmNewPasswordChanged(String text) =
      _ConfirmNewPasswordChangedEvent;
