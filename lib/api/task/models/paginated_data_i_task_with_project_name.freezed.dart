...
PaginatedDataITaskWithProjectName _$PaginatedDataITaskWithProjectNameFromJson(
  ...
  return _PaginatedDataITaskWithProjectName.fromJson(json);
}
...
/// @nodoc
class _$PaginatedDataITaskWithProjectNameCopyWithImpl<$Res,
        $Val extends PaginatedDataITaskWithProjectName>
    implements $PaginatedDataITaskWithProjectNameCopyWith<$Res> {
  _$PaginatedDataITaskWithProjectNameCopyWithImpl(this._value, this._then);
...
class _$PaginatedDataITaskWithProjectNameImpl implements _PaginatedDataITaskWithProjectName {
  ...
  @override
  String toString() {
    return 'PaginatedDataITaskWithProjectName(items: $items, total: $total, page: $page, size: $size, pages: $pages, nextPage: $nextPage, previousPage: $previousPage)';
  }
