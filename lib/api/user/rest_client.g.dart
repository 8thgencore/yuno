...
class _UserClient implements UserClient {
  ...
  Future<IUserRead> postUser({required IUserCreate body}) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<IUserRead>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late IUserRead _value;
    try {
      _value = IUserRead.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BaseResponse<IRoleRead>> getUserList({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<IRoleRead>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<IRoleRead> _value;
    try {
      _value = BaseResponse<IRoleRead>.fromJson(
        _result.data!,
  ...
  @override
  Future<BaseResponse<IUserRead>> deleteMyAccount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
