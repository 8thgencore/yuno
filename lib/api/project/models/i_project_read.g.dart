...
_$_IProjectRead _$$_IProjectReadFromJson(Map<String, dynamic> json) => _$_IProjectRead(
...
Map<String, dynamic> _$$_IProjectReadToJson(_$_IProjectRead instance) => <String, dynamic>{
      'name': instance.name,
